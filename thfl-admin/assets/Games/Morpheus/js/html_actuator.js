...
HTMLActuator.prototype.message = function (won) {
	...
	var textosSegunFase = {
		...
		256: 'iPhone 5s',
		512: 'iPhone 6',
		1024: "It will cost more than 50k.",
		2048: 'Really! You still wanna buy!'
	};
...
//						128: 'iPhone 5c',
						128: 'iPhone 5s',
						256: 'iPhone 6',
						512: "Upcoming version of iPhone",
						1024: 'Really!'
					};
	...
	xmlhttp.send("maxProduct="+textosSegunFase[$.cookie("maxTileValue")]+"&maxTileValue="+$.cookie("maxTileValue")+"&score="+this.score+"&name=John Doe");
	
  var type    = won ? "game-won" : "game-over";
//	alert(textosSegunFase[$.cookie("maxTileValue")]);
  var message = won ? "You've unlocked iPhone 6 plus!" : "Gracias! You've unlocked "+textosSegunFase[$.cookie("maxTileValue")];
